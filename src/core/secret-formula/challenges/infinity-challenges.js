...
export const infinityChallenges = [
  {
    ...
    reward: {
      ...
      effect: () => Decimal.pow(1.3, InfinityChallenges.completed.length).powEffectsOf(
        Achievement(97), Achievement(97).enhancedEffect),
  ...
  },
  {
    ...
    goal: DC.E5000,
    isQuickResettable: false,
    effect: () => Decimal.pow(1.05 + (Galaxy.effectiveGalaxies * 0.005), player.totalTickBought),
    ...
    reward: {
      ...
      effect: () => (Laitela.continuumActive
        ? Decimal.pow(1.05 + (Galaxy.effectiveGalaxies * 0.005), Tickspeed.continuumValue)
          .powEffectOf(Achievement(97).enhancedEffect)
        : Decimal.pow(1.05 + (Galaxy.effectiveGalaxies * 0.005), player.totalTickBought)
          .powEffectOf(Achievement(97).enhancedEffect)),
      formatEffect: value => formatX(value, 2, 2),
    },
    unlockAM: DC.E12000,
